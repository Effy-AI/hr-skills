...
One question at a time, up to 8 questions:

- Who on the team uses Claude, and for what?
- Which account type are we on?
...
- AI never makes employment decisions — hiring, ratings, comp, promotion, discipline,
  termination.
- Screening and candidate scoring need named approval before they happen.
...
an incident section (report the same day, no blame, add a rule so it can't repeat) and a
sign-off table.
